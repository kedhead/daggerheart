import { Home, Users, BookOpen, ScrollText, Wrench, Crown, User, LogOut, FolderOpen, UserCog, FolderUp, UsersRound, Calendar, Map, Swords, StickyNote, Wand2, Settings } from 'lucide-react';
...
export default function SidebarWithAuth({ currentView, setCurrentView, isDM, userRole, currentCampaign, onSwitchCampaign }) {
  ...
  if (isDM) {
    ...
    navItems.push({ id: 'apiSettings', label: 'API Settings', icon: Settings });
